...
[mean(data_1.age) mean(data_2.age) mean(data_3.age)]

[mean(data_1.counts_profileVisits) mean(data_2.counts_profileVisits) mean(data_3.counts_profileVisits)]

[mean(data_1.counts_pictures) mean(data_2.counts_pictures) mean(data_3.counts_pictures)]

[mean(data_1.lang_count) mean(data_2.lang_count) mean(data_3.lang_count)]

[mean(data_1.isVerified) mean(data_2.isVerified) mean(data_3.isVerified)]
